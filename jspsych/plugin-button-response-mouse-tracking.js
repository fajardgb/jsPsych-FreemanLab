/**
 * Original from https://github.com/mahiluthra/mousetracking_experiment
 * Updated by Yara Studer
 **/

var jsPsychButtonResponseMouseTracking = (function (jspsych) {
	"use strict";

	const info = {
		name: 'button-mouse-response-tracking',
		parameters: {
			stimulus: {
	...
	class ButtonResponseMouseTrackingPlugin {
		constructor(jsPsych) {
	...
	ButtonResponseMouseTrackingPlugin.info = info;

	return ButtonResponseMouseTrackingPlugin;
